...
export default function Gallery({
  images = [
  assetPath('/assets/img/gallery/img1.jpg'),
  assetPath('/assets/img/gallery/img2.jpg'),
  assetPath('/assets/img/gallery/img3.jpg'),
  assetPath('/assets/img/gallery/img4.jpg'),
  assetPath('/assets/img/gallery/img5.jpg'),
  assetPath('/assets/img/gallery/img6.jpg'),
  assetPath('/assets/img/gallery/img7.jpg'),
  assetPath('/assets/img/gallery/img8.jpg'),
  assetPath('/assets/img/gallery/img9.jpg'),
  assetPath('/assets/img/gallery/img10.jpg'),
  assetPath('/assets/img/gallery/img11.jpg'),
  assetPath('/assets/img/gallery/img4.jpg'),
],
  ...
  <div className="categories__title-wrap text-center text-lg-start m-0 ">
                                <div className="section__title mb-10">
                                    <span className="sub-title"> Captured progress </span>
