                        ...
                        <div className="row align-items-center gap-4 gap-md-0">
                            <div className="col-md-8">
                                <div className="section__title text-center text-md-start">
                                    ...
                                    <h2 className="title tg-svg">Group <span className="position-relative"><span className="svg-icon" id="svg-8" data-svg-icon="/punchi-pasala/assets/img/icons/title_shape.svg" />Members</span>
                                        </h2>
                                </div>
                            </div>
