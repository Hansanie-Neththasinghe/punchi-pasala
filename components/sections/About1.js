                    ...
                    <div className="row align-items-center justify-content-center">
                        <div className="col-xl-6 col-lg-8">
                            <div className="about__images">
                                <img className="small-img tg-motion-effects3" src="/punchi-pasala/assets/img/kids/5.4.png" alt="img" />
                                <img className="big-img" src="/punchi-pasala/assets/img/kids/1.png" alt="img" />
                                ...
                                <img src="/punchi-pasala/assets/img/others/about_dots.svg" alt="svg" className="dots tg-motion-effects2" />
                        ...
                        <div className="col-xl-6 col-lg-7">
                            <div className="about__content">
                                <div className="section__title">
                                    ...
                                    <h2 className="title tg-svg">Making Learning Accessible for   <span className="position-relative"><span className="svg-icon" id="svg-3" data-svg-icon="/punchi-pasala/assets/img/icons/title_shape.svg" />Every</span>
                                        Child</h2>
                                </div>
                                ...
                                <ul className="about__info-list list-wrap">
                                    <li className="about__info-list-item">
                                        ...
                                        <p className="content"> Identification Activities</p>
                                    </li>
                                    <li className="about__info-list-item">
                                        <div className="icon"><i className="flaticon-file" /></div>
                                        <p className="content"> Improvement Activities</p>
                                    </li>
                                    <li className="about__info-list-item">
                                        <div className="icon"><i className="flaticon-graduation-cap" /></div>
                                        <p className="content"> Progress Tracking</p>
                                    </li>
                                    <li className="about__info-list-item">
                                        <div className="icon"><i className="flaticon-video-player" /></div>
                                        <p className="content"> Sinhala Sign Language Instructions</p>
                                    </li>
                                </ul>
                                <div className="tg-button-wrap">
                                    <Link href="/about-us" className="btn tg-svg"><span className="text">Discover More</span> <span className="svg-icon" id="about-btn" data-svg-icon="/punchi-pasala/assets/img/icons/btn-arrow.svg" /></Link>
                                </div>
                            </div>
                        </div>
                    </div>
