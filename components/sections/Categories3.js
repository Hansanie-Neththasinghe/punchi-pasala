                        ...
                        <div className="col-xl-7 col-lg-8 col-md-10">
                            <div className="categories__title-wrap text-center text-lg-start m-0">
                                <div className="section__title mb-0">
                                    <span className="sub-title">Assessing Difficulties I
                                        ndependently</span>
                        ...
                        <div className="col">
                            <div className="categories__item-three">
                                <Link href="/#">
                                    ...
                                    <div className="info">
                                        <div className="list"><span className="courses">Math - 1</span></div>
                                        <div className="list"><span className="name">Operational Dyscalculia</span></div>
                                    </div>
                                </Link>
                            </div>
                        </div>
                        <div className="col">
                            <div className="categories__item-three">
                                <Link href="/#">
                                    ...
                                    <div className="info">
                                        <div className="list"><span className="courses">Math - 2</span></div>
                                        <div className="list"><span className="name">Practognostic Dyscalculia</span></div>
                                    </div>
                                </Link>
                            </div>
                        </div>
                        <div className="col">
                            <div className="categories__item-three">
                                <Link href="/#">
                                    ...
                                    <div className="info">
                                        <div className="list"><span className="courses">Writing - 1</span></div>
                                        <div className="list"><span className="name">Number Dysgraphia</span></div>
                                    </div>
                                </Link>
                            </div>
                        </div>
                        <div className="col">
                            <div className="categories__item-three">
                                <Link href="/#">
                                    ...
                                    <div className="info">
                                        <div className="list"><span className="courses">Writing - 2</span></div>
                                        <div className="list"><span className="name">Spatial Dysgraphia</span></div>
                                    </div>
                                </Link>
                            </div>
                        </div>
