...
less ability to perform when compared to typical primary school students. Most of the deaf
and mute students, remain untreated, including Practognostic Dyscalculia, which affects
a child's comprehension of numerical magnitudes, comparisons, and practical
mathematical applications. Existing diagnostic tools and intervention methods rely
heavily on verbal and auditory instructions, which makes them inaccessible to deaf and
mute students. Moreover, most existing resources are not customized for Sinhala-speaking
students in Sri Lanka and lack integration with Sri Lankan Sign Language (SLSL). By
creating a nonverbal, visual diagnostic tool to detect Practognostic Dyscalculia in deaf and
mute primary school students and offering targeted learning activities to improve their
numerical reasoning, this study seeks to close these gaps. Interactive exercises that support
sign language will be incorporated into the proposed system to assess and enhance
mathematics comprehension. It will also provide relevant instructional materials, such as
sign language instructions, that are easily understandable to deaf and mute primary school
students. This project aims to provide an inclusive and successful learning framework by
including interactive exercises, adaptive difficulty levels, and Sri Lankan Sign Language.
Children with learning disabilities will have additional possibilities to acquire critical
numerical skills and succeed academically as well as their daily routine which will also
benefit special education and assistive learning technology in Sri Lanka. 
                                            </p>
                                        </div>
