                    ...
                    <div className="container">
                                    ...
                                    <div className="tab-content" id="myTabContent">
                                        <div className={activeIndex === 1 ? "tab-pane fade show active" : "tab-pane fade"}>
                                            <Link href="#" className="popup-image">
                                                <img src={assetPath("/assets/img/shop/shop_details01.jpg")} alt="" />
                                            </Link>
                                        </div>
                                        <div className={activeIndex === 2 ? "tab-pane fade show active" : "tab-pane fade"}>
                                            <Link href="#" className="popup-image">
                                                <img src={assetPath("/assets/img/shop/shop_details02.jpg")} alt="" />
                                            </Link>
                                        </div>
                                    ...
                                    <ul className="nav nav-tabs" id="myTab" role="tablist">
                                        <li className="nav-item" onClick={() => handleOnClick(1)}>
                                            <button className={activeIndex === 1 ? "nav-link active" : "nav-link"}>
                                                <img src={assetPath("/assets/img/shop/shop_nav01.jpg")} alt="" />
                                            </button>
                                        </li>
                                        <li className="nav-item" onClick={() => handleOnClick(2)}>
                                            <button className={activeIndex === 2 ? "nav-link active" : "nav-link"}>
                                                <img src={assetPath("/assets/img/shop/shop_nav02.jpg")} alt="" />
                                            </button>
                                        </li>
                        ...
                        <div className="related-product-area">
                            <div className="section__title mb-50">
                                <h2 className="title tg-svg">Related <span className="position-relative"><span className="svg-icon" id="related-title" data-svg-icon={assetPath("assets/img/icons/title_shape.svg")} />products</span></h2>
                            </div>
                            <ShopRelatedSlider1 />
                        </div>
                    </div>
